...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['auth', 'admin:products.manage'])->group(function () {
        ...
        Route::get('/products/bulk', [AdminProductController::class, 'bulkUpload'])->name('products.bulk');
        Route::get('/products/template', [AdminProductController::class, 'downloadTemplate'])->name('products.template');
        Route::post('/products/bulk', [AdminProductController::class, 'import'])->name('products.import');
